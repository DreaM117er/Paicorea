...
|9|平口老虎鉗|分離拼接電路板時使用||
|10|銼刀|打磨電路板邊框時用||
|11|皮革打洞器|裁切矽膠墊使用|需要打ø4-4.5mm的孔|
...
- 務必將所有元件都焊接在同一面。
- 焊接MCU、二極體、鍵軸及LED燈等... 都務必都要進行測試再做下一步動作。
- 只要有安裝方向的元件都會標示在電路板上，反之沒有安裝方向的元件什麼都不會標記。
- MCU上的THT焊盤孔用作定位使用。
- 使用焊接工具時務必注意安全，小心燙傷。
...
|圖示|說明|
|--|--|
|![](pic/pic8.jpg)|首先將`MCU`、`USB-C`接口、`5.1K`電阻及`FFC`排線座焊接好。|
|![](pic/pic9.jpg)|連接電腦測試MCU的狀態，如果順利接通MCU的話，MCU上面的`橘紅色LED燈`會閃爍。|
|![](pic/pic10.jpg)|請根據RP2040的燒錄方式將韌體燒錄至MCU，成功的話LED燈會亮，還有VIAL會成功讀取到鍵盤。|
|![](pic/pic11.jpg)|再來焊接TRRS座。|
|![](pic/pic13.jpg)|接著按照順序將`1N4148`及`PG1316S`焊接起來，PG1316S的燈光孔是可以容下1N4148的，務必將二極體包覆在軸燈燈孔裡面。|
...
|![](pic/pic24.jpg)|接上排線，稍微彎折收納一下排線。|
|![](pic/pic25.jpg)|鎖上螺絲。|
|![](pic/pic26.jpg)|然後翻到背面貼上腳貼或自行DIY上Tending。|
|![](pic/pic27.jpg)|安裝鍵帽之後就完成啦。|
